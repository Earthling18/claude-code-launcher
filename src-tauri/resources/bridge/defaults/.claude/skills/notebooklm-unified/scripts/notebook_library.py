#!/usr/bin/env python3
"""
Notebook Library Management for NotebookLM Unified Skill
Manages a library of NotebookLM notebooks with metadata.
Data stored at ~/.notebooklm/library.json (alongside notebooklm-py auth data).
"""
...
class NotebookLibrary:
    ...
    def __init__(self):
        ...
        # Store data in ~/.notebooklm/ (shared with notebooklm-py CLI)
        self.data_dir = Path.home() / ".notebooklm"
...
def main():
    ...
    if args.command == 'add':
        ...
        if notebooks:
            ...
            print("Library is empty. Add notebooks with: notebook_library.py add")
